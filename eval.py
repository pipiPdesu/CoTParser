...
if __name__ == "__main__":
    ...
    parser.add_argument("--prediction", type=str, help="Path to the predictions file.", default='data/Final_Selection_Train_v2.json')
    parser.add_argument("--reference", type=str, help="Path to the reference file.", default='data/Final_Selection_Train_v2.json')
    # parser.add_argument("--output", type=str, help="Path to the output file.")
    parser.add_argument(
        "--sample_rate",
        type=float,
        default=1.0,
        help="Sample rate to evaluate the predictions.抽样机制是抽前百分之多少的数据",
    )
    parser.add_argument(
        "--question_threshold",
        type=float,
